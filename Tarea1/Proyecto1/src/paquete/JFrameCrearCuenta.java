...
public class JFrameCrearCuenta extends javax.swing.JFrame {
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
      String contra;
       contra = jPasswordField2.getText();
    if(contra.length()>=8)
    {
        ...
        //Pattern eight = Pattern.compile (".{8}");
           ...
           Matcher hasLetter = letter.matcher(contra);
           Matcher hasDigit = digit.matcher(contra);
           Matcher hasSpecial = special.matcher(contra);

          if (hasLetter.find() && hasDigit.find()) {
              hasSpecial.find();
              Component f = null;
              JOptionPane.showMessageDialog(f,"Contraseña valida, Cuenta Creada","Alert",JOptionPane.WARNING_MESSAGE);
          }
    }
    else {
         Component f = null;
         JOptionPane.showMessageDialog(f,"Contraseña incorrecta","Alert",JOptionPane.WARNING_MESSAGE);
      }
